...
import { PageResponseFeedbackResponse } from '../../types/page-response-feedback-response';
...
export class FeedbackService {
  ...
  findAllFeedbackByProduct(
    params: FindAllFeedbackByProduct$Params
    ...
    return this.http.get<PageResponseFeedbackResponse>(
      `${this.rootUrl}/feedbacks/product/${params['product-id']}`,
      { params: httpParams }
    );
  }
}
